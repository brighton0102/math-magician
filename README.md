...
You can find a live demo in [HERE](https://moonlit-licorice-d1a14e.netlify.app/).
...
```sh
cd math_magicians
git clone git@github.com:brighton0102/math-magician.git
```
...
This project is [MIT](https://github.com/brighton0102/math-magician/blob/dev/LICENSE) licensed.
